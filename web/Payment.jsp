                    ...
                    <div class="row">
                        <div class="col-md-12 col-lg-7">
                            <div class="summary">
                                ...
                                <div class="mt-3">
                                    <a type="button" href="#" class="btn btn-primary btn-lg btn-block">Thanh toán</a>
                                </div>
                            </div>
                        ...
                        <div class="col-md-12 col-lg-5">
                            ...
                            <div class="cash"  id="cash">
                                ...
                                <div class="input-group input-group-sm mb-3 mt-3">
                                    <span class="input-group-text" id="inputGroup-sizing-sm">Số tiền trả lại</span>
                                    <input type="text" class="form-control" aria-label="Sizing example input"
                                        aria-describedby="inputGroup-sizing-sm">
                                </div>
                            ...
                            <div class="mt-5 ">
                                <button type="button" class="btn btn-primary btn-lg btn-block">Hoàn thành</button>
                            </div>
