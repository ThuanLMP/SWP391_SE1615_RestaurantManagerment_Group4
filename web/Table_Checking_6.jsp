<%-- 
    Document   : Table_Checking_6
    Created on : Jun 8, 2022, 3:53:52 PM
    Author     : ITACHI
--%>
                ...
                <div class="mt-5 content-1 mr-4">
                    <div
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-md-4">
                                <p class="text-dark">ID:M01</p>
                                <%
                                    int check01 = 0;
                                    for (Table t : tables) {
                                        if (t.getId().equals("M01") && t.isStatus() == false) {
                                            check01 = 1;
                                %>
                    ...
                    <div
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-md-4">
                                <p class="text-dark">ID:M02</p>
                                <%
                                    int check02 = 0;
                                    for (Table t : tables) {
                                        if (t.getId().equals("M02") && t.isStatus() == false) {
                                            check02 = 1;
                                %>
                    ...
                    <div
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-md-4">
                                <p class="text-dark">ID:M03</p>
                                <%
                                    int check03 = 0;
                                    for (Table t : tables) {
                                        if (t.getId().equals("M03") && t.isStatus() == false) {
                                            check03 = 1;
                                %>
                ...
                <div class="mt-5 content-1">
                    <div
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-md-4">
                                <p class="text-dark">ID:M04</p>
                                <%
                                    int check04 = 0;
                                    for (Table t : tables) {
                                        if (t.getId().equals("M04") && t.isStatus() == false) {
                                            check04 = 1;
                                %>
                    ...
                    <div
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-12 col-md-4">
                                <p class="text-dark">ID:M05</p>
                                <%
                                    int check05 = 0;
                                    for (Table t : tables) {
                                        if (t.getId().equals("M05") && t.isStatus() == false) {
                                            check05 = 1;
                                %>
